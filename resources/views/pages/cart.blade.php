            ...
            <div class="col-12 table-responsive">
              <table class="table table-borderless table-cart">
                ...
                <tbody>
                  <tr>
                    <td style="width: 25%;">
                        <img class="w-100" src="images/product-cart-1.jpg" class="cart-image"></td>
                    <td style="width: 35%;">
                   ...
                   <tr>
                    <td style="width: 25%;"><img class="w-100" src="images/product-cart-2.jpg" class="cart-image"></td>
                    <td style="width: 35%;">
                   ...
                   <tr>
                    <td style="width: 25%;"><img class="w-100" src="images/product-cart-3.jpg" class="cart-image"></td>
                    <td style="width: 35%;">
