...
<div class="page-content page-auth" id="register">
    <section class="section-store-auth" data-aos="fade-up">
        <div class="container">
            <div class="row d-flex mt-5 align-items-center row-login justify-content-center">

                <div class="col-lg-4">
                    <h2>Memulai untuk jual <br>beli dengan cara terbaru </h2>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="email" type="email" @change="checkForEmailAvailbility()"
                                :class="{'is_invalid' : this.email_unavailable}" v-model="email"
                        ...
                        <div class="form-group" v-if="is_store_open">
                            ...
                            <input type="text" name="store_name" id="store_name" class="" v-model="store_name"
                        ...
                        <button type="submit" href="{{ route('dashboard') }}" class="btn btn-success btn-block  mt-4"
